...
def create_budget_screen(user, database, screen):
    ...
    Label(text="Add new planned expense", font=("Montserrat", 14)).grid(row=5, columnspan=4) 
    ...
    Label(text="Existing planned expenses", font=("Montserrat", 14)).grid(row=8, columnspan=4) 
...
def show_budget_table(screen):
    ...
    Label(text="Total Planned Expenses", font=("Montserrat", 14)).grid(row=3, columnspan=4) 
    Label(text=total_budget, font=("Montserrat", 14)).grid(row=4, columnspan=4) 
