...
def create_expenses_screen(user, database, screen):
    ...
    Label(text="Add new expense", font=("Montserrat", 14)).grid(row=5, columnspan=4) 
    ...
    Label(text="Existing expenses", font=("Montserrat", 14)).grid(row=8, columnspan=4) 
...
def show_expense_table(screen):
    ...
    for expense in expenses:
        n = int(n + 1)
        Label(text = expense["Title"] , font=("Montserrat", 10)).grid(row=int(10+n), column=1) 
        Label(text = expense["Category"] , font=("Montserrat", 10)).grid(row=int(10+n), column=2) 
        Label(text = expense["Amount"] , font=("Montserrat", 10)).grid(row=int(10+n), column=3) 
