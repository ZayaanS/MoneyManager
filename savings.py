...
def create_savings_screen(user, database, screen):
    ...
    Label(text="Your Savings", font=("Montserrat", 16), bg ="white").grid(row=2, columnspan=4) 
    # create input field for new savings item
    Label(text="Add new savings item", font=("Montserrat", 14), bg ="white").grid(row=5, columnspan=4) 
    ...
    add_savings_button = Button(screen, text="Add", height="2", width="15", font=("Montserrat", 10), bg ="white", command = lambda : add_new_savings(user, database, screen))
    add_savings_button.grid(row=7, column=4)
    # table to display current savings values
    Label(text="Existing savings", font=("Montserrat", 14), bg ="white").grid(row=8, columnspan=4) 
...
def show_savings_table(screen):
    ...
    Label(text="Total Savings", font=("Montserrat", 14), bg ="white").grid(row=3, columnspan=4) 
    Label(text=total_savings, font=("Montserrat", 14), bg ="white").grid(row=4, columnspan=4) 
